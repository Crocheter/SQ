...
const DRAWER_ITEMS = [
  { label: "Play the Day's Challenge", slug: 'daily-challenge' },
  { label: 'Contribute Signs', slug: 'contribute-signs' },
  { label: 'Leave Feedback', slug: 'feedback' },
...
const DESKTOP_ITEMS = [
  { label: "Day's Challenge", slug: 'daily-challenge' },
  { label: 'Contribute Signs', slug: 'contribute-signs' },
    ...
    <header className="absolute inset-x-0 top-0 z-30 flex items-center justify-between px-5 py-5 sm:px-10 sm:py-6">
      ...
      >
        <div className="mb-8 flex items-center justify-between">
          <span className="font-display text-base font-semibold text-paper">Menu</span>
          <button
            type="button"
            onClick={() => setOpen(false)}
